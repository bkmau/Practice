...
class FontDemo extends JFrame {
 ...
 //================================================================ constants
 private static final int    INITIAL_DISPLAY_SIZE  = 20;
 private static final int    INITIAL_DISPLAY_STYLE = Font.PLAIN;
 ...
 public FontDemo() {
     ...
     _displayArea = new FontPanel(INITIAL_FONTNAME, INITIAL_DISPLAY_STYLE, INITIAL_DISPLAY_SIZE, false);
     ...
     _sizeSlider = new JSlider(JSlider.HORIZONTAL, 5, 60, INITIAL_DISPLAY_SIZE);
